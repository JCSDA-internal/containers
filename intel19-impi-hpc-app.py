...
Stage0 += environment(variables={'NETCDF':'/usr/local/jedi',
                                 'NETCDF_ROOT':'/usr/local/jedi',
                                 'PNETCDF':'/usr/local/jedi',
                                 'HDF5_ROOT':'/usr/local/jedi',
                                 'PIO':'/usr/local/jedi',
                                 'BOOST_ROOT':'/usr/local/jedi',
                                 'EIGEN3_INCLUDE_DIR':'/usr/local/jedi',
                                 'SERIAL_CC':'icc',
                                 'SERIAL_CXX':'icpc',
                                 'SERIAL_FC':'ifort',
                                 'MPI_CC':'mpiicc',
...
Stage1 += x.runtime()
Stage1 += u.runtime()
Stage1 += copy(_from='build', src='/usr/local/jedi', dest='/usr/local/jedi')
Stage1 += copy(_from='build', src='/jedi/build', dest='/jedi/build')
