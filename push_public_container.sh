...
echo "=============================================================="
echo "   Pushing Charliecloud Container" ${CNAME}_${TAG}
echo "=============================================================="

get_ans "Push Charliecloud container?"
...
if [[ $ans == y ]] ; then
	...
	aws s3 cp containers/ch-${CNAME}_${TAG}.tar.gz s3://data.jcsda.org/containers/ch-jedi-${CNAME}.tar.gz
else
   echo "Not pushing Charliecloud image"
fi

echo "=============================================================="
echo "   Pushing Singularity Image" ${CNAME}
echo "=============================================================="

get_ans "Push Singularity image?"
...
if [[ $ans == y ]] ; then
  ...
  if [[ $(echo $CNAME| cut -d- -f1) == "intel" ]]; then
	...
	aws s3 cp containers/${CNAME}_${TAG}.sif s3://data.jcsda.org/containers/jedi-${CNAME}.tar.gz
   ...
   echo "Not pushing Singularity image"
fi
